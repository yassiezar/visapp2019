...
In comparison to the remotely-assisted VizWiz system~\cite{bigham2010vizwiz} covered in Section~\ref{sec:previous-work} (mean 92s, standard deviation 37.7s), our results look very encouraging, although there might be significant variations in case of participants with actual vision impairments.
